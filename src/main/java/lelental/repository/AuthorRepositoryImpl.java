...
public class AuthorRepositoryImpl implements AuthorRepository {
    ...
    @Override
    public List<Author> findByName(String name) throws SQLException {
    ...
    public void populateDb() throws SQLException {
        connection.createStatement().executeUpdate("CREATE TABLE Author(id bigint GENERATED BY DEFAULT AS IDENTITY ,name VARCHAR(20) NOT NULL, date_of_creation DATE NOT NULL, PRIMARY KEY (id))");
    }
    ...
    public void setConnection(Connection connection) throws SQLException {
        ...
        findByName = connection.prepareStatement("SELECT id,name,date_of_creation FROM Author WHERE name = ?");
    }
